...
def init_driver(
    ...
    def build_page_bundle(init_params: str) -> str:
        parts = [
            ...
            ,
            """
            // ——— Cleanup public markAsNative ———//
            (function cleanupMarkAsNative(G){
                try {
                    if (G && Object.prototype.hasOwnProperty.call(G, 'markAsNative')) delete G.markAsNative;
                    if (typeof globalThis !== 'undefined' && Object.prototype.hasOwnProperty.call(globalThis, 'markAsNative')) delete globalThis.markAsNative;
                    if (G && Object.prototype.hasOwnProperty.call(G, 'markAsNative')) {
                        throw new Error('cleanupMarkAsNative: delete failed (window)');
                    }
                    if (typeof globalThis !== 'undefined' && Object.prototype.hasOwnProperty.call(globalThis, 'markAsNative')) {
                        throw new Error('cleanupMarkAsNative: delete failed (globalThis)');
                    }
                } catch (e) {
                    if (typeof __DEGRADE__ === 'function') __DEGRADE__('core_window:cleanup_markAsNative_failed', e);
                    throw e;
                }
            })(window);
            """
