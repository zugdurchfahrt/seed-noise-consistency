...
def run():
    ...
    if do_prelude:
        ...
        tostring_sanity_expr = (
            ...
            " let coreToStringNoWeakMapFieldsOk = null;"
            " let wrapperApisOk = null;"
            " try {"
            "   const s = runtimeRoot && runtimeRoot.__CORE_TOSTRING_STATE__;"
            "   const weakFieldNames = ['overrideMap','proxyTargetMap','toStringOverrideMap','toStringProxyTargetMap'];"
            "   coreToStringNoWeakMapFieldsOk = !!(s && weakFieldNames.every(function(k) { return !Object.prototype.hasOwnProperty.call(s, k) && !(s[k] instanceof WeakMap); }));"
            "   wrapperApisOk = !!(runtimeRoot"
            "     && typeof runtimeRoot.__registerToStringWrapper === 'function'"
            "     && typeof runtimeRoot.__wrapNativeApply === 'function'"
            "     && typeof runtimeRoot.__wrapNativeAccessor === 'function'"
            "     && typeof runtimeRoot.__wrapNativeCtor === 'function');"
            "   coreToStringStateOk = !!(s && s.__CORE_TOSTRING_STATE__ === true && typeof s.nativeToString === 'function' && coreToStringNoWeakMapFieldsOk && wrapperApisOk);"
            " } catch (e) {}"
            ...
            " } catch (e) {}"
            " return { coreToStringStateOk, coreToStringNoWeakMapFieldsOk, wrapperApisOk, toStringBaselineOk };"
            "})()"
        )
